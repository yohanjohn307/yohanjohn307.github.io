...
I am a Ph.D. candidate in Mechanical Engineering at the University of California, Santa Barbara, advised by Professors [Francesco Bullo](https://fbullo.github.io/index.html) and [Jason R. Marden](https://web.ece.ucsb.edu/~jrmarden/). My research sits at the intersection of control theory, operations research, and optimization with a focus on resource allocation problems in stochastic systems. Current projects include multi-robot surveillance strategy optimization and inventory control for industrial refrigeration networks.
